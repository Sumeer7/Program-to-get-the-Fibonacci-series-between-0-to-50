...
class Theatre:
    ...
    def book_ticket(self):
        ...
        if row >= self.rows or col > self.cols:
            ...
            print(Color.GREEN+Color.BOLD +"Price for the seat you are booking is: $"+ Color.END, self.seats[row][col].price)
            option1 = "yes"
            option2="no"
...
while option != 0:
    if option == 1:
        ...
        theatre.print_seats()
        print()
        print(Color.BOLD +"Number of Vacant seats: "+Color.END ,theatre.vacant_seats-theatre.no_of_purchased_tickets)
        print()
